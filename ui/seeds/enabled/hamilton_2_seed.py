...
class Hamilton2Seed:
    def __init__(self):
        self.frames = {}
        self.frame_index = 1
        self.rect = pygame.Rect(0, 0, 100, 100)  # Tamaño inicial del rectángulo
    ...
    def load_frame(self, index):
        if index not in self.frames:
            ...
            if os.path.exists(frame_path):
                ...
                surf = pygame.transform.scale(surf, (90, 90))  # Escala la imagen a 80x80 píxeles
    ...
    def update_animation(self):
        ...
        self.load_frame(self.frame_index)  # Cargar solo el frame actual si no está cargado
