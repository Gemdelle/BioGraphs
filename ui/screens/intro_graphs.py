...
def render_intro_graphs(screen, go_to_level):
    ...
    render_tutorial_dialogue(screen, 'To navigate a graph, start at a chosen node and move along its edges to connected nodes.\n\nYou can only move to nodes that are directly connected by an edge,\nregardless of the direction!', font)
