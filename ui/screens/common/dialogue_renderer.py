...
def render_tutorial_dialogue(screen, text, font, avatar_mood="neutral"):
    # Cargar las imágenes de los marcos
    dialogue_frame = pygame.image.load("./assets/dialogue/dialogue-frame-tutorial.png").convert_alpha()
    character_frame = pygame.image.load("./assets/dialogue/character-frame-tutorial.png").convert_alpha()
