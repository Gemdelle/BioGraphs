...
def render_grafos_hamilton_1(screen, font):
    ...
    if not timer_started:
        start_button_clicked_grafos_hamilton_1 = render_start_button(screen, font, AnimatedSprite(frame_path="./assets/giphs/seeds/hamilton-1-seed/hamilton-1-seed", frame_size=(90, 90), frame_count=74))
    else:
