...
def render_grafos_euler_3(screen, font):
    ...
    if not timer_started:
        start_button_clicked_grafos_euler_3 = render_start_button(screen, font, AnimatedSprite(frame_path="./assets/giphs/seeds/euler-3-seed/euler-3-seed", frame_size=(90, 90), frame_count=74))
    else:
