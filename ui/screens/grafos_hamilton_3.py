...
def render_grafos_hamilton_3(screen, font):
    ...
    global back_button_clicked_grafos_hamilton_3, start_button_clicked_grafos_hamilton_3,\
        ...
        positions, current_node, energy, won_level, flower, missing_nodes, remaining_time, main_menu_button_clicked_grafos_hamilton_3
    ...
    if not timer_started:
        start_button_clicked_grafos_hamilton_3 = render_start_button(screen, font_start, AnimatedSprite(frame_path="./assets/giphs/seeds/hamilton-3-seed/hamilton-3-seed", frame_size=(150, 150), frame_count=74))
        ...
        render_counter(screen,font,missing_nodes, AnimatedSprite(frame_path="./assets/giphs/seeds/hamilton-3-seed/hamilton-3-seed", frame_size=(90, 90), frame_count=74))
...
def handle_grafos_hamilton_3_mousedown(event, go_to_level):
    global back_button_clicked_grafos_hamilton_3, start_button_clicked_grafos_hamilton_3, restart_button_clicked_grafos_hamilton_3, timer_started, main_menu_button_clicked_grafos_hamilton_3
