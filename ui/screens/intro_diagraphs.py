...
def render_intro_diagraphs(screen, go_to_level):
    ...
    render_tutorial_dialogue(screen, 'For a digraph, start at a chosen node and move along its directed edges to connected nodes.\n\nBe careful, you can only move to nodes that are connected\nby edges in the direction specified!', font)
