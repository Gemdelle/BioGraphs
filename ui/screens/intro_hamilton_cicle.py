...
back_button_clicked_intro_hamilton_cicle = None

def render_intro_hamilton_cicle(screen, font):
    global back_button_clicked_intro_hamilton_cicle
    ...
    back_button_clicked_intro_hamilton_cicle = pygame.Rect(1610, 10, 80, 40)  # Posición y tamaño del botón
    pygame.draw.rect(screen, (0, 0, 200), back_button_clicked_intro_hamilton_cicle)  # Fondo del botón
...
def is_back_button_clicked_intro_hamilton_cicle(event):
    global back_button_clicked_intro_hamilton_cicle
    return back_button_clicked_intro_hamilton_cicle is not None and back_button_clicked_intro_hamilton_cicle.collidepoint(event.pos)
