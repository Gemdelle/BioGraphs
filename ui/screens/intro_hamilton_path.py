...
back_button_clicked_intro_hamilton_path = None

def render_intro_hamilton_path(screen, font):
    global back_button_clicked_intro_hamilton_path
    ...
    back_button_clicked_intro_hamilton_path = pygame.Rect(1610, 10, 80, 40)  # Posición y tamaño del botón
    pygame.draw.rect(screen, (0, 0, 200), back_button_clicked_intro_hamilton_path)  # Fondo del botón
...
def is_back_button_clicked_intro_hamilton_path(event):
    global back_button_clicked_intro_hamilton_path
    return back_button_clicked_intro_hamilton_path is not None and back_button_clicked_intro_hamilton_path.collidepoint(event.pos)
