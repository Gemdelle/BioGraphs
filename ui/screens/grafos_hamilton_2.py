...
def render_grafos_hamilton_2(screen, font):
    global back_button_clicked_grafos_hamilton_2
...
def is_back_button_clicked_grafos_hamilton_2(event):
    global back_button_clicked_grafos_hamilton_2
    return back_button_clicked_grafos_hamilton_2 is not None and back_button_clicked_grafos_hamilton_2.collidepoint(event.pos)
