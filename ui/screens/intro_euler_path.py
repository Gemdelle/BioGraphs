...
back_button_clicked_intro_euler_path = None

def render_intro_euler_path(screen, font):
    global back_button_clicked_intro_euler_path
    ...
    back_button_clicked_intro_euler_path = pygame.Rect(1610, 10, 80, 40)  # Posición y tamaño del botón
    pygame.draw.rect(screen, (0, 0, 200), back_button_clicked_intro_euler_path)  # Fondo del botón
...
def is_back_button_clicked_intro_euler_path(event):
    global back_button_clicked_intro_euler_path
    return back_button_clicked_intro_euler_path is not None and back_button_clicked_intro_euler_path.collidepoint(event.pos)
