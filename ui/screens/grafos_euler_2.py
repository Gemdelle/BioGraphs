...
def render_grafos_euler_2(screen, font):
    ...
    global back_button_clicked_grafos_euler_2, start_button_clicked_grafos_euler_2, restart_button_clicked_grafos_euler_2,\
        ...
        won_level, remaining_time, main_menu_button_clicked_grafos_euler_2
...
def handle_grafos_euler_2_mousedown(event, go_to_level):
    global back_button_clicked_grafos_euler_2, start_button_clicked_grafos_euler_2, restart_button_clicked_grafos_euler_2, timer_started, main_menu_button_clicked_grafos_euler_2
...
def reset_nodes(path):
    ...
    seeds = {
        ...
        'H': AnimatedSprite(frame_path="./assets/giphs/bugs/bug-euler-2/euler-bug-2", frame_size=(120, 120), frame_count=74)
    }
