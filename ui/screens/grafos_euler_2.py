...
def render_grafos_euler_2(screen, font):
    ...
    global back_button_clicked_grafos_euler_2, start_button_clicked_grafos_euler_2,  timer_started, start_time, path, start_node, positions, current_node, energy
...
def handle_grafos_euler_2_mousedown(event, go_to_map):
    global back_button_clicked_grafos_euler_2, start_button_clicked_grafos_euler_2, timer_started
