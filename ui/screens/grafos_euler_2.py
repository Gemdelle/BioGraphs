...
seeds = {
    'A': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'B': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'C': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'D': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'E': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'F': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'G': AnimatedSprite(frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74),
    'H': AnimatedBug(-20, 20, frame_path="./assets/giphs/bugs/bug-euler-2/euler-2-bug",
                     frame_size=(120, 120), frame_count=74)
}

dead_flower = AnimatedSprite(frame_path="./assets/giphs/flowers-bw/euler-2-flower-bw/euler-2-flower-bw",
                             frame_size=(480, 480), frame_count=74)
flower = AnimatedSprite(frame_path="./assets/giphs/flowers/euler-2-flower/euler-2-flower", frame_size=(480, 480),
                        frame_count=74)
...
def render_grafos_euler_2(screen, font):
    ...
    global back_button_clicked_grafos_euler_2, start_button_clicked_grafos_euler_2, restart_button_clicked_grafos_euler_2, \
        ...
        won_level, remaining_time, main_menu_button_clicked_grafos_euler_2, lost_level, time_finishing_warning_done
    ...
    if won_level:
        ...
        render_dialogue(screen,
                        "Restore the plant 'Frood' by solving the Euler path before the timer runs out."
    ...
    if lost_level:
        ...
        start_button_clicked_grafos_euler_2 = render_start_button(screen, font_start, AnimatedSprite(
            frame_path="./assets/giphs/seeds/euler-2-seed/euler-2-seed", frame_size=(150, 150), frame_count=74))
    else:
        ...
        render_counter(screen, font, missing_edges,
                       AnimatedSprite(frame_path="./assets/giphs/seeds/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                                      frame_count=74))
...
def handle_grafos_euler_2_mousedown(event, go_to_level, is_screen_on_focus):
    global back_button_clicked_grafos_euler_2, start_button_clicked_grafos_euler_2, \
        restart_button_clicked_grafos_euler_2, \
    ...
    if back_button_clicked_grafos_euler_2 is not None and back_button_clicked_grafos_euler_2.collidepoint(event.pos):
        ...
        reset_nodes(path)
    elif restart_button_clicked_grafos_euler_2 is not None and restart_button_clicked_grafos_euler_2.collidepoint(
            event.pos):
        play_button('button.mp3')
        reset_nodes(path)
    elif start_button_clicked_grafos_euler_2 is not None and start_button_clicked_grafos_euler_2.collidepoint(
            event.pos):
        play_button('button.mp3')
        timer_started = True
    elif main_menu_button_clicked_grafos_euler_2 is not None and main_menu_button_clicked_grafos_euler_2.collidepoint(
            event.pos):
        play_button('button.mp3')
        reset_nodes(path)
    ...
    if event.type == pygame.KEYDOWN:
        ...
        if key in G.nodes:
            if current_node is None:
                ...
                seeds[current_node] = AnimatedSprite(frame_path="./assets/giphs/seeds/euler-2-seed/euler-2-seed",
                ...
                if edge not in visited_edges and (key, current_node) not in visited_edges:
                    ...
                    seeds[current_node] = AnimatedSprite(
                        frame_path="./assets/giphs/seeds-b&w/euler-2-seed/euler-2-seed", frame_size=(90, 90),
                        frame_count=74)
                    play_button('node.mp3')
                    current_node = key
                    missing_edges -= 1
