...
class AnimatedBug:
    def __init__(self, x_position_extra, y_position_extra, frame_path, frame_size=(100, 100), frame_count=1):
        ...
        self.visible = False
        self.x_position_extra = x_position_extra
        self.y_position_extra = y_position_extra
    ...
    def draw(self, screen, x, y):
        ...
        self.rect.center = (x+self.x_position_extra, y+self.y_position_extra)
        if not self.visible:
            self.load_frame(self.frame_index)
