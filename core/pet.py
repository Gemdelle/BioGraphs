...
def get_selected_pet(size=(150, 150)):
    if selected_pet[0] is not None and selected_pet[0].upper() == "DARK":
        ...
        return AnimatedSprite(frame_path="./assets/giphs/frog/neutral/frog-common/frog-common", frame_size=size, frame_count=192)
    elif selected_pet[0] is not None and selected_pet[0].upper() == "SWAMP":
        return AnimatedSprite(frame_path="./assets/giphs/frog/neutral/frog-swamp/frog-swamp", frame_size=size, frame_count=192)
    return None